...
Route::group(['prefix' => 'sponsors'], function () {
	...
	Route::group(['prefix' => '/{sponsor}/offers'], function () {
		Route::get('/create', [App\Http\Controllers\Admin\SponsorController::class, 'create'])->middleware(['permission:create offer'])->name('admin.sponsors.offers.create');
		Route::post('/create', [App\Http\Controllers\Admin\SponsorController::class, 'create'])->middleware(['permission:create offer'])->name('admin.sponsors.offers.store');
